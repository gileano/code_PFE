...
targets a classical combinatorial or continuous problem -- a knapsack,
a benchmark function, a charging network, a vehicle-routing instance --
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/qft_example.png}
  \caption{A 4-qubit quantum Fourier transform circuit ($H$, controlled
    phase rotations, and a final \texttt{SWAP} layer), drawn directly
    from this survey's own case-study pipeline's circuit generator
