...
solution actually dominates. The indicators used throughout this survey
and in the case study (Section~\ref{sec:case-study}) are:
\begin{itemize}
  ...
  \item \textbf{Inverted Generational Distance (IGD)}: the average
    ...
    front to be known or well-approximated.
  \item \textbf{Spread and spacing}: measures of how evenly solutions are
    ...
    that front is to the true optimum.
\end{itemize}
