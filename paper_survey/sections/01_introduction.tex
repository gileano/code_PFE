...
computing~\citep{banciu2026aiot}. This is one of the underlying reasons
...
\begin{itemize}
  ...
  \item A systematic feature comparison of the surveyed methods against
    that taxonomy, covering representation, complexity, scalability,
    convergence properties, benchmark problems, and reported performance
